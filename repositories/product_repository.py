...
class ProductRepository:
    ...
    def get_all_active(self) -> list[Product]:
        return (
            ...
            .options(
                ...
                joinedload(Product.product_toppings).joinedload(ProductTopping.topping),
            )
    ...
    def get_by_category(self, category_id: int) -> list[Product]:
        return (
            ...
            .options(joinedload(Product.sizes))
            .order_by(Product.name)
            .all()
        )
    ...
    def get_all_categories(self) -> list[Category]:
        return self._session.query(Category).order_by(Category.name).all()

    def get_all_toppings(self) -> list[Topping]:
        return self._session.query(Topping).order_by(Topping.name).all()
